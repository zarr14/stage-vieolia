...
<h1 class="text-3xl font-bold mb-4">Edit Employer</h1>
...
<div  class="flex justify-end" ><button class="py-2 px-4 bg-green-500 text-white rounded hover:bg-green-600 transition duration-300" type="submit">Update</button></div>
</form>
</div>
@endsection
