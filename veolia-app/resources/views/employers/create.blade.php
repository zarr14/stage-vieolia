...
<h1 class="text-3xl font-bold mb-4">Create New Employer</h1>
<form action="{{ url('/employers') }}" method="POST" class="bg-white p-6 rounded shadow-md space-y-4">
    ...
    <button type="submit"  class="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300" >Submit</button>
</div>
</form>
</div>
@endsection
